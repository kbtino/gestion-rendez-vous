...
SECRET_KEY = 'django-insecure-v9vmapgorlot714#**sr^9n1sh3p)$k$9fu8%ife&f*%i)k%%9'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware', # 🔹 ajout CORS
]

# Autoriser Angular à accéder à Django
...
# Definition des frameworks rest
